...
//3234733078
//        $call = $client->account->calls->create("+19165121922", "+1".$_REQUEST['txt_api_key'], "http://demo.twilio.com/docs/voice.xml", array());
		$call = $client->account->calls->create("+19165121922", "+13234733078", "http://s606346885.onlinehome.us/test_dial2");

        //echo $call->sid;
        echo "<br>We are calling on +1 ".$_REQUEST['txt_api_key'];
        die;
    } catch (Exception $e) {
